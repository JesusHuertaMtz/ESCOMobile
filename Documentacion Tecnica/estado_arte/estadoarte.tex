...
\subsection{NET ANAHUAC}
	...
	\noindent
	Esta aplicación, que se encuentra disponible para IOS y Android, está hecha para la Universidad Anáhuac y conecta a todos los usuarios de las escuelas de la Anahuac en toda la Republica, se puede consultar en cualquier momento y en cualquier lugar.
	...
	\begin{table}[!htb]
		...
		\begin{tabular}{@{}|c|c|c|@{}}
		\toprule
		Caracterásticas Académicas & Información Financiera & Otros  
		\\ \midrule
			\begin{tabular}[c]{@{}c@{}}
				-Búsqueda de Cursos,\\ -Cursos Planeados,\\ -Cita de Inscripción,\\ -Horario,\\ -Perfil,\\ -Situación Academica,\\ -Calificaciones Parciales,\\ -Historia Académica,\\ -Mi Avance.
			\end{tabular} & 
			\begin{tabular}[c]{@{}c@{}}
