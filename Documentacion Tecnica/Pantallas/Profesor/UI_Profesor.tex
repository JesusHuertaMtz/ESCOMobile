...
\subsubsection{Comandos}
	\begin{itemize}
		...
		\item \IUbutton{Comentarios}: Muestra pantalla con los comentarios del profesor.
...
\begin{itemize}
	\item Botón de regreso: Para regresar a la pantalla anterior.
	\item Botón \IUbutton{Comentarios}: para consultar los comentarios asignados por los alumnos.
\end{itemize}
