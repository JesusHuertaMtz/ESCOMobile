...
\begin{UCtrayectoria}{Principal}
	...
	% Paso 11.
	\UCpaso Muestra la pantalla \IUref{EM-Citas-UI1-2}{Consultar citas por Confirmar} con el mensaje \MSGref{MSG1}{Operación Exitosa} y la infomación actualizada.
