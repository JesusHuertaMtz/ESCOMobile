\begin{UseCase}{EM-Mapa-CU02}{Realizar Búsqueda Sobre el Mapa.}{
	\noindent
	Este caso de uso permite al actor realizar una búsqueda de cubículos de profesores, salones, grupos 
	o academmias de su interés dentro del mapa de la ESCOM por medio de ESCOMobile. Para ello basta con
