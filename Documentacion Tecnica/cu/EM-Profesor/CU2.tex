...
\begin{UseCase}{EM-Profesor-CU2}{Consultar Perfil de otro Profesor.}{
	...
	nombre, fotografía, académia, cubículo y calificación promedio. Además, sirve de acceso para consultar su horario y estadísticas de desempeño docente, calificarlo, o bien, ubicarlo en
	el mapa de ESCOM. 
	\newline
	}
	\UCitem{Versión}{0.1}
...
\begin{UCtrayectoriaA}{A}{Cuando el profesor no tiene un cubículo asignado.}
	...
	% A1.
	\UCpaso	Asigna la leyenda ''sin cubículo asignado'' al espacio dedicado al cuículo en la pantalla \IUref{EM-Profesor-UI2}{Consultar Perfil de otro Profesor}.
	% A2.
