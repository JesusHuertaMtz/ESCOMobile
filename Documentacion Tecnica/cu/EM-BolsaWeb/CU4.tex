...
\begin{UseCase}{EM-BolsaWeb-CU4}{Gestionar Empresas}{
		Este caso de uso permite al actor gestionar las empresas de la bolsa de trabajo de ESCOMobile, dando un punto de acceso al registro, edición, consulta y eliminación de las empresas en el sistema, pues son las empresas quienes ofertarán trabajo a los alumnos de la ESCOM interesados en encontrar empleo.
	}
	\UCitem{Versión}{0.1}
