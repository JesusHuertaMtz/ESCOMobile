...
%\begin{UseCase}[archivo de imágen]{UCX}{Nombre del Caso de uso}{
	\begin{UseCase}{CU1.3}{EM-WebBolsa-CU1.3-Consultar ofertas de trabajo }{
		En este caso de uso el actor podrá visualizar las ofertas de trabajo registradas para los Alumnos de la ESCOM las cuales tendrán un tiempo de vigencia no maximo a 6 meses, estas mismas pueden tener dos estatus: publicadas o sin publicar. Así el actor tendrá un mejor control de las ofertas de trabajo que ha registrado y publicado.}
		\UCitem{Versión}{0.3}
		\UCitem{Actor}{Encargado de Bolsa de Trabajo}
		\UCitem{Propósito}{Visualizar todas las ofertas de trabajo que se han publicado y las que no se han publicado.}
	...
	\UCpaso Separa las ofertas de trabajo sin publicar.	\Trayref{A}
	\UCpaso Genera una descripción textual del horario con base en la regla de negocio. \BRref{EM-RN-S008}.
	\UCpaso Muestra la pantalla  \IUref {EM-BolsaWeb-UI1}{Gestionar Ofertas de Trabajo} con una tabla de Ofertas sin publicar la cual que tiene los siguiente atributos
	\begin{itemize}
	\item No.
	\item Nombre de la empresa.
	\item Horario.
