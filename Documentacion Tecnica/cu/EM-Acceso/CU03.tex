	...
	\begin{UseCase}{EM-Acceso-CU3}{Recuperar Contraseña.}{
		...
		\UCitem{Errores}{
			\begin{enumerate}[\hspace*{0.5cm} \bfseries{E}1:]	
				...
				\item \label{EM-Acceso-CU03-E2} Cuando no se introduce un correo electronico existente. Muestra el mensaje \MSGref{MSG10}{Correo Electronico inexistente} y \textbf{termina el caso de uso.}
			\end{enumerate}	
		}
