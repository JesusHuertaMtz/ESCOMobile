...
\begin{UseCase}{EM-AlumnoProfesor-CU1.1.1}{Consultar Horario del Profesor.}{
	...
	\UCitem{Errores}{
		\begin{enumerate}[\hspace*{0.5cm} \bfseries{E}1:]
			...
			\item \label{EM-AlumnoProfesor-CU1-1-1-E1} Cuando no hay materias asociadas al profesor, muestra el mensaje \MSGref{MSG3}{Elementos No Disponibles} y \textbf{termina el caso de uso}.
		\end{enumerate} 
	}
