...
\begin{UseCase}{EM-AlumnoProfesor-CU1}{Buscar Profesor de ESCOM.}{
	...
	ecuentren registrados como usuarios de la app, pues se tiene registro de ellos igualmente en el sistema.
	Sin embargo, de ser el caso, solo se podrá coonsultar la información de los referidos, mas no se
	...
	\UCitem{Salidas}{
		\begin{itemize}
			...
			ESCOM, o bien, los coicidentes con la búsqueda. 
		\end{itemize}
	}
	...
	\UCitem{Revisor}{Fernándes Quiñones Isaac.}
...
\begin{UCtrayectoria}{Principal}
	...
	%Paso 9.
	\UCpaso Verifica que haya concidencias con los profesores en el sistema, comparando el nombre introducido con los nombres de profesores dados de alta en la aplicación. \Trayref{A}.
