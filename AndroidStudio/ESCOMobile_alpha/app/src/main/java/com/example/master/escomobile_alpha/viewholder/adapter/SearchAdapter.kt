...
import com.example.master.escomobile_alpha.viewholder.SearchViewHolder
...
class SearchAdapter( val context: Context ): RecyclerView.Adapter<SearchViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SearchViewHolder, position: Int) {
        ...
        if( !searchResult[position].nombre.equals( FormValidator.SIN_RESULTADO_BUSQUEDA ) ) {
